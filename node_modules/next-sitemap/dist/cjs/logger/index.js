...
class Logger {
     ...
     * @returns
     */
    static generationCompleted(allSitemaps) {
        // Initial stats
        Logger.log(`✅`, `Generated index sitemap and ${(allSitemaps === null || allSitemaps === void 0 ? void 0 : allSitemaps.length) - 1} sitemap(s)`);
        // Temp assign
